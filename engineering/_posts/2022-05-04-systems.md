...
Requirements that specify what *not* to do can be difficult to verify. For instance, "shall not fail under xxx circumstances" requires a lot of definition about what exactly these circumstances are. 
