...
|-
| A high level overview which outlines the overall goals and objectives. Usually includes context or rational details for why things are the way they are. This is frequently a user or customer facing document.

| Mission Operations Document (MOD)
|-
| A more detailed outline of your procedures than the CONOPS. A MOD can provide specific details about what your hardware (or an operator) needs to do. 

| Recommended Operating Procedures (ROP)
|-
| The most detailed document of the three, a ROP is as detailed as you can get before actually implementing a solution. For things like commanding or telemetry, a ROP can be as specific as the individual bits in a dataframe. In an OSI context, this means going down to the Data Link Layer (layer 2).
