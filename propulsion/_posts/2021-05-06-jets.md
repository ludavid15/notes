...
For the sake of simplicity, jet engines can be analyzed as a quasi 1 dimensional system. In other words we only need to consider velocities in one direction. This makes our math much easier. 
