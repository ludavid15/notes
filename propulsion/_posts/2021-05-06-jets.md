...
In 1941, a Messerschmitt Me 262 became the world's first operational jet powered aircraft. Relying on combustion and a nozzle, the new "jet engine" was conceptually more similar to a rocket than a propeller. 

80 years later, jet engines have continued to rule the aviation world.
...
![turbojet](../images/jetBasic.png){: .center-image }


|                   | Diffuser  |	Compressor |	Burner |	Turbine	 | Nozzle
|π (Pressure Ratio) |1	        |   $${\tau_c}^{\gamma/(\gamma-1)}$$|	1	| $${\tau_t}^{\gamma/(\gamma-1)}$$ |	1|
|τ (Temp Ratio)	    |1	        | $$\tau_c$$	| $$\tau_b$$	| $$\tau_t$$	| 1
...
Ramjets function like a turbojet, but do not include a turbine or compressor. Most of the original equations still apply. Set $$\tau_c=\ \tau_t=1$$.
...
When considering a real ramjet, diffuser and nozzle are still largely adiabatic, but there is an associated drop in total pressure
...
![afterburner](../images/afterBurner.png){: .center-image }
...
A turbofan makes of use the turbine in a turbojet to generate shaft power which drives a ducted fan. It provides increased efficiency over a regular turbojet. Most commercial passenger planes fly with turbofan engines.

![turboFan](../images/turboFan.png){: .center-image }
...
![rotor and stator](../images/rotAndStat.png){: .center-image }
