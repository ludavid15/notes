...
In other words, if dynamics is the study of rules, controls is the study of how we use those rules to achieve results. 
...
Stable
1. All poles must be in the LHP

Marginally Stable
1. There are no poles in the RHP
2. There are poles on the imaginary axis
3. Poles on the imaginary axis are non-repeated 

Unstable
1. Any pole in the RHP makes a system unstable
